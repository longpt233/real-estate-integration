...
PATH_ALO = "/content/drive/MyDrive/20212/class/tich-hop-du-lieu/bai-tap-lon/real-estate-integration/standard_data/alonhadat.csv"
alo = pd.read_csv(PATH_ALO, encoding = 'utf-8') 
df2 = alo 
# df2["address"]  = alo["district"] + alo["province"] + alo["street"] + alo["ward"]


PATH_I = "/content/drive/MyDrive/20212/class/tich-hop-du-lieu/bai-tap-lon/real-estate-integration/standard_data/ibatdongsan.csv"
